...
<link href="/web/theme/assets/admin/pages/css/lock.css" rel="stylesheet" type="text/css"/>
...
<div class="page-lock">
	<div class="page-logo">
		...
		<img src="/web/theme/assets/admin/layout4/img/logo-big.png" alt="logo"/>
		</a>
	</div>
	<div class="page-body">
		<div class="lock-head">
		...
		<div class="lock-body">
			<div class="pull-left lock-avatar-block">
				<img src="/web/theme/assets/admin/pages/media/profile/photo3.jpg" class="lock-avatar">
			</div>
...
<script src="/web/theme/assets/global/plugins/backstretch/jquery.backstretch.min.js" type="text/javascript"></script>
