...
<head>
<meta charset="utf-8"/>
<title>Smart cafe service | Login</title>
...
<link href="/web/theme/assets/global/plugins/select2/select2.css" rel="stylesheet" type="text/css"/>
<link href="/web/theme/assets/admin/pages/css/login3.css" rel="stylesheet" type="text/css"/>
...
<link href="/web/theme/assets/admin/layout/css/themes/default.css" rel="stylesheet" type="text/css" id="style_color"/>
...
<div class="logo">
	<a href="index.html">
	<img src="/web/theme/assets/admin/layout4/img/logo-big.png" alt=""/>
	</a>
</div>
<!-- END LOGO -->
...
<div class="content">
	<!-- BEGIN LOGIN FORM -->
	<form class="login-form" action="<?php echo $view['router']->generate('sc_login_authentication'); ?>" method="post">
...
<script src="/web/theme/assets/global/plugins/jquery-validation/js/jquery.validate.min.js" type="text/javascript"></script>
<script type="text/javascript" src="/web/theme/assets/global/plugins/select2/select2.min.js"></script>
...
<script src="/web/theme/assets/admin/pages/scripts/login.js" type="text/javascript"></script>
<!-- END PAGE LEVEL SCRIPTS -->
<script>
